...
// Route::get('/tasks/export-csv', [TaskController::class, 'exportTask'])->name('tasks.task');
Route::get('users/export/', [TaskController::class, 'exportTask'])->name('task');
// Route::get('tasks/export-csv', 'TaskController@exportCsv')->name('tasks.exportCsv');
